...
var SettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Title Bar").addButton((bc) => this.highlightElement(bc, ".titlebar")).setDesc("Completely hide Title bar (but it will still technically be there for dragging the window).").addToggle((tc) => tc.setValue(this.plugin.settings.preferences.titleBar).onChange(async (value) => {
...
var ZenView = class extends import_obsidian2.View {
  ...
  async toggleZen(activePaneOnly = false) {
    ...
    this.plugin.settings.enabled && activePaneOnly ? this.plugin.settings.activePaneOnly = true : this.plugin.settings.activePaneOnly = false;
    if (this.plugin.settings.enabled && activePaneOnly && this.app.workspace.getMostRecentLeaf(this.app.workspace.rootSplit) && typeof this.app.workspace.getMostRecentLeaf(this.app.workspace.rootSplit) != "undefined")
